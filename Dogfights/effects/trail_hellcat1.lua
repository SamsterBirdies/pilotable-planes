...
LifeSpan = 198420
SoundEvent = "mods/dogfights/effects/trail_hellcat"
Effects =
{
	{
		Type = "sparks",
		...
		{
			{
				...
				AgeMean = 0.8,				-- mean age in seconds (normal distribution)
				...
				colour = { 80, 100, 128, 255 }, -- Colour used to modulate the sprite
			},
		},
	},
}
